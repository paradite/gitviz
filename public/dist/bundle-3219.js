...
/***/ function(module, exports, __webpack_require__) {
	...
	/* WEBPACK VAR INJECTION */(function(__webpack_provided_viz_dot_chart, __webpack_provided_viz_dot_data, d3, __webpack_provided_viz_dot_ui) {var allUsers = [];
	...
	__webpack_provided_viz_dot_chart.init(width, 0, margin);

	function updateAxis() {
	  __webpack_provided_viz_dot_chart.setScaleDomain(__webpack_provided_viz_dot_data.getDomain(__webpack_provided_viz_dot_data.dateAccessor));
	  __webpack_provided_viz_dot_chart.updateAxisElment();
	}
...
/***/ function(module, exports, __webpack_require__) {
	...
	/* WEBPACK VAR INJECTION */(function(d3, __webpack_provided_viz_dot_data) {d3.tip = __webpack_require__(9);
	...
	var chart = (function() {
	  ...
	  function reScaleCommits() {
	    _chartElement
	      ...
	      .attr('cx', function(d) {
	        return _xScale(__webpack_provided_viz_dot_data.dateAccessor(d));
	      });
	  }
	  ...
	  function getTooltipContent(d) {
	    var text = __webpack_provided_viz_dot_data.getPrimaryTooltipData(d);

	    if (d.commits.length <= __webpack_provided_viz_dot_data.MAX_COMMITS) {
	      for (var i = 0; i < d.commits.length; i++) {
	        text += formatSecondaryData(__webpack_provided_viz_dot_data.getSecondaryTooltipDataByIndex(d, i));
	      }
	    } else {
	      for (i = 0; i < __webpack_provided_viz_dot_data.MAX_COMMITS; i++) {
	        text += formatSecondaryData(__webpack_provided_viz_dot_data.getSecondaryTooltipDataByIndex(d, i));
	      }
	      text += formatAdditionalData(__webpack_provided_viz_dot_data.getAdditionalTooltipData(d));
	    }
	    return text;
	  }
...
/***/ function(module, exports, __webpack_require__) {
	...
	/* WEBPACK VAR INJECTION */(function(d3, __webpack_provided_viz_dot_util) {var async = __webpack_require__(6);
	...
	var data = (function() {
	  ...
	  var _handleCommitDetail = function(user, cb, err, res, repo) {
	    if (err) {
	      ...
	      var commitDate = __webpack_provided_viz_dot_util.parseDate(res['commit']['author']['date']);
	      // Expose date at outer level
	      res['date'] = commitDate;
	      // add repo attr
	      res['repo'] = repo;
	      var dateOnly = __webpack_provided_viz_dot_util.formatDateOnly(commitDate);
	  ...
	  var addCommitByDate = function(user, date, commit) {
	    ...
	    _commitsByDate[user.username].push({
	      dateStr: date,
	      date: __webpack_provided_viz_dot_util.formatDateOnly.parse(date),
	      commits: [commit],
	  ...
	  module.getPrimaryTooltipData = function(d) {
	    return d.username + '(' + d.name + ') ' + __webpack_provided_viz_dot_util.formatDateNice(d.date);
	  };
	  ...
	  function _getCommitTime(commit) {
	    return __webpack_provided_viz_dot_util.formatTime(commit.date);
	  }
...
/***/ function(module, exports, __webpack_require__) {
	...
	/* WEBPACK VAR INJECTION */(function(d3) {var util = (function() {
	  var module = {};
...
/***/ function(module, exports, __webpack_require__) {
	...
	/* WEBPACK VAR INJECTION */(function(d3) {var ui = (function() {
	  var module = {};
...
/***/ function(module, exports, __webpack_require__) {
	...
	donutChart.initContributionChart = function(userName, repoName) {
	  ...
	  __webpack_provided_viz_dot_data.getContribution(userName, repoName, handleNewContribution);
	};
...
/***/ function(module, exports, __webpack_require__) {
	...
	/* WEBPACK VAR INJECTION */(function($) {notifDialog = {};
